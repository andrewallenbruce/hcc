...
test_that("Age calculation", {
  ...
  expect_all_equal(
    c(
      calculate_age("invalid"),
      calculate_age("999999999"),
      calculate_age("")
    ),
    NA_integer_
  )
...
test_that("Medi-Cal eligibility status can be derived from dates", {
  expect_all_equal(
    c(
      medi_cal_status("2025-11-30", "2025-11-15"),
      medi_cal_status("2025-12-31", "2025-11-15"),
      medi_cal_status("2025-11-01", "2025-11-15")
    ),
    "Active"
  )
  ...
  expect_all_equal(
    c(
      medi_cal_status("2025-10-31", "2025-11-15"),
      medi_cal_status("2025-09-30", "2025-11-15"),
      medi_cal_status("2025-10-31", "2025-11-01")
    ),
    "Terminated"
  )

  expect_error(medi_cal_status(NULL, "2025-11-15"))
  expect_error(medi_cal_status("", "2025-11-15"))
})
