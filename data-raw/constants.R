...
#
# Args: status: Medicare status code (e.g., 'QMB Plus', 'SLMB', 'QI')
...
map_medicare_status_to_dual_code <- function(status) {
  ...
  x <- MEDICARE_STATUS_CODE_MAPPING[normalized]
  if (is.na(x)) {
...
#
# Args: aid_code: California aid code (e.g., '4N', '5B')
# Returns: Dual eligibility code ('01'-'08') or '00' if not found
